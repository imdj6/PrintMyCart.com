...
import HeroImage1 from "../assets/images/background1.png";
  ...
  return (
    <div>
      <div className="relative font-[poppins]">
        <img
          src={HeroImage}
          className="object-cover h-[60vh] lg:h-[67vh] w-full "
          alt="heroimage"
        />
      ...
      <section className="relative">
        <div className="relative mt-10">
          <img
            src={HeroImage1}
            className="w-full h-40 lg:h-46 object-cover"
            alt="aboutimage"
          />
        </div>
        <div className="tracking-[2px] absolute top-14  left-[38%] lg:left-[40%] text-5xl text-center text-white ">
      ...
      <div className="flex justify-center space-x-10 lg:space-x-32 m-24">
        <div>
          <img src={Group1} width={200} />
        </div>
        <div>
          <img src={Group2} width={200} />
        </div>
        <div>
          <img src={Group3} width={200} />
        </div>
        <div>
          <img src={Group4} width={200} />
        </div>
      </div>
    </div>
  );
